...
public class AuthenFilter implements Filter {
    ...
    private final String START_APP = "homePage";
    ...
    public AuthenFilter() {
        ...
        admin.add("error.jsp");
        admin.add("homepage.jsp");
        admin.add("createCoupon.jsp");
        ...
        admin.add("CreateCouponController");
        ...
        member.add("searchBooking.jsp");
        member.add("AddToCartController");
        member.add("ApplyCouponController");
        member.add("CancelController");
        member.add("CheckoutController");
        member.add("ConfirmController");
        member.add("DeleteCartController");
        member.add("DetailController");
        member.add("FeedbackController");
        member.add("HomePageController");
        member.add("LogoutController");
        member.add("SearchBookingController");
        member.add("SearchController");
        member.add("SubmitCartController");
        member.add("TrackBookingController");
...
//        }
        try {
            ...
            LOG.error("Error at AuthenFilter: " + e.toString());
        }
    }
