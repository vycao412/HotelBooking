<%-- 
    Document   : homepage
    Created on : Dec 17, 2020, 10:58:36 PM
    Author     : VYCAO
--%>
    ...
    <body>
        ...
        <div class="album py-5 bg-light">
            <div class="container">
                ...
                <div class="row">
                    <c:if test="${not empty requestScope.LIST_HOTEL_EMPTY}">
                        <font>${requestScope.LIST_HOTEL_EMPTY}</font>
                    </c:if>
                </div>                   
                <c:remove var="LIST_HOTEL_EMPTY" scope="request"></c:remove>
